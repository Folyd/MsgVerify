...
public class HttpsUtil {
	...
	private static HttpsURLConnection getConnectionForSms(String urlString)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static String postForSms(String url, String data,
			String authorization) throws MalformedURLException,
			ProtocolException, IOException {
		byte[] d = null;
		HttpsURLConnection conn = getConnectionForSms(url);
		conn.setRequestMethod("POST");
		conn.setDoOutput(true);
		conn.setRequestProperty("Content-Type",
				"application/json;charset=utf-8");
